...
const expectedBuilds = {
    '25.12.5': {
        ...
        backend: /^zte-usb-wifi-manager-[A-Za-z0-9._~+-]+\.apk$/,
        luci: /^luci-app-zte-usb-wifi-manager-[A-Za-z0-9._~+-]+\.apk$/
    },
    '24.10.7': {
        ...
        backend: /^zte-usb-wifi-manager_[A-Za-z0-9._~+-]+_all\.ipk$/,
        luci: /^luci-app-zte-usb-wifi-manager_[A-Za-z0-9._~+-]+_all\.ipk$/
    }
};
