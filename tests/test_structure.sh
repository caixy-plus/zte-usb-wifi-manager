...
assert_file_contains "$backend/Makefile" '^PKG_RELEASE:=29$'
...
assert_file_contains README.md 'r25→r26 QEMU 升级及 Cudy/U30 只读验收通过'
...
assert_file_contains README.md '源码 backend r29 / LuCI r12'
